...
{
    public class ServicoTerceirosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public ServicoTerceirosController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: ServicoTerceiros
        public async Task<IActionResult> Index()
        {
            return View(await _context.ServicoTerceiros.ToListAsync());
        }

        // GET: ServicoTerceiros/Details/5
        ...
        // GET: ServicoTerceiros/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ServicoTerceiros/Create
        ...
        // POST: ServicoTerceiros/Delete/5
